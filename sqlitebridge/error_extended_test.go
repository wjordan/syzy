...
// SQLITE_CONSTRAINT_COMMITHOOK so embedders can tell "coordinated commit
// rejected — retry the transaction off the writer" apart from an ordinary
// UNIQUE/NOT NULL violation (same primary SQLITE_CONSTRAINT code).
