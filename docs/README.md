...
3. [System architecture](ARCHITECTURE.md) — end-to-end responsibilities and
   lifecycle.
...
- [Pruning](PRUNING.md) — SQLite history retention and shared offline-peer
  contracts.
...
- [SQLite engine architecture](../sqlite/docs/ARCHITECTURE.md)
- [DDL realization](../sqlite/docs/DDL.md)
- [Syzy for Postgres](../pg/README.md) — quickstart and operations
- [Postgres engine architecture](postgres.md) — capture, apply, DDL, merge
